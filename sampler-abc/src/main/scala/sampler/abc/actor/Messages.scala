...
case class WeighJob[P](scored: ScoredParticles[P], previousPopulation: Map[P, Double], tolerance: Double) extends Job[P]
...
case class ScoredParticles[P](seq: Seq[Tagged[Scored[P]]]) extends WorkerResult[P]{
  ...
  def empty = ScoredParticles(Seq.empty[Tagged[Scored[P]]])
...
case class WeighedParticles[P](seq: Seq[Tagged[Weighted[P]]]) extends WorkerResult[P]{
  ...
  def empty = WeighedParticles(Seq.empty[Tagged[Weighted[P]]])
